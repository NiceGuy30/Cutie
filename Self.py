...
with st.container():
   ...
   st.write("Part of General Luna’s yearly fiesta – the island’s biggest, with two weeks of parades, parties, live bands and discos.") 
   st.write("Other fiestas include Dapa in January, San Benito in March, San Isidro in May, Socorro in June, Del Carmen and Burgus in July, Santa Monica in August, Pilar in October")
